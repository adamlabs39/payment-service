...
const DBSeeder = async () => {
    ...
    try {
        ...
        const serviceTemplates = [
            ...
            { type: 'LAB', practitioner: 'Analis Lab', serviceName: 'Pemeriksaan Darah Lengkap', with_insurance: false, items: [{ item_name: 'Jasa Ambil Sampel Darah', price: 50000, category_code: '1' }, { item_name: 'Pemeriksaan Hematologi', price: 150000, category_code: '5' }] },
            { type: 'FISIO', practitioner: 'Fisioterapis', serviceName: 'Sesi Fisioterapi', with_insurance: true, items: [{ item_name: 'Sesi Terapi Punggung', price: 250000, category_code: '1' }] }
        ];
